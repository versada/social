...
odoo.define('mail_activity_board/static/src/components/chatter_topbar/chatter_topbar.js', function (require) {
'use strict';
...
patch(components.ChatterTopbar, 'mail_activity_board/static/src/components/chatter_topbar/chatter_topbar.js', {
    //--------------------------------------------------------------------------
    // Handlers
    //--------------------------------------------------------------------------
